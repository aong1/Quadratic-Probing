...
int main()
{
   ...
   //Insert into table that is full without being full.
   testOther();
...
void testOther(){
   ...
   passed += checkTest("Other 2", table.size(), 1);
   ...
   passed += checkTest("Other 6", table.size(), 1);
   ...
   passed += checkTest("Other 9", table.size(), 0);
   passed += checkTest("Other 10", table.empty(), true);

   passed += checkTest("Other 11", Hashtable::isPrime(349), true);
   passed += checkTest("Other 12", Hashtable::isPrime(343), false);
   passed += checkTest("Other 13", Hashtable::isPrime(5), true);
   passed += checkTest("Other 14", Hashtable::isPrime(2017), true);
   passed += checkTest("Other 15", Hashtable::isPrime(993), false);
   passed += checkTest("Other 16", Hashtable::isPrime(101), true);
   passed += checkTest("Other 17", Hashtable::nextPrime(93), 97);
   passed += checkTest("Other 18", Hashtable::nextPrime(102), 103);
   passed += checkTest("Other 19", Hashtable::nextPrime(984), 991);
   passed += checkTest("Other 20", Hashtable::nextPrime(258), 263);

   cout << "Passed " << passed << "/20 optional tests" << endl;
   cout << "Score: " << passed << endl;
}
